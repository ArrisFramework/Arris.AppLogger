...
class AppLogger implements AppLoggerInterface, AppLoggerConstants
{
    ...
    public static function addScope($scope = null, $scope_levels = [], $scope_logging_enabled = true, $is_deferred_scope = false)
    {
        ...
        try {
            ...
            foreach ($scope_levels as $level) {
                ...
                $level_options = array(
                    'enable'    =>  self::setOption($level, 'enable', $scope_logging_enabled),
                    'bubbling'  =>  self::setOption($level, 'bubbling', self::$_global_config['bubbling']),
                    'handler'   =>  self::setOption($level, 'handler', StreamHandler::class)
                );
    ...
    /**
     * internal implementation of setOption() method
     *
     * @param array $options
     * @param null $key
